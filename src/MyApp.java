...
public class MyApp extends Application {
    ...
    public void loadLoginPage() {
        String filePath = new File("resources/Login_Page.html").toURI().toString();
    ...
    public void loadMonitorPage(String resultText) {
        Platform.runLater(() -> {
            String filePath = new File("resources/Monitor_Page.html").toURI().toString();
            webEngine.load(filePath);
    ...
    public void loadGetGuiPage() {
        Platform.runLater(() -> {
            String filePath = new File("resources/Get_Set_Page.html").toURI().toString();
            webEngine.load(filePath);
    ...
    public void loadControlPage() {
        Platform.runLater(() -> {
            String filePath = new File("resources/Control_Page.html").toURI().toString();
            webEngine.load(filePath);
